...
```sh
git clone https://github.com/GiovanniCastorina/nomad-plugin-qutip.git
cd nomad-plugin-qutip
...
```sh
pip install dist/nomad-plugin-qutip-0.1.0
```
